                        ...
                        <div class="form-group col-md-3 input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Kode Member"
                                    ...
                                    value="{{ $edit->nobase }}" aria-describedby=" basic-addon2" readonly>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="">
                                <input type="text" class="form-control" placeholder="Nama Member"
                                    ...
                                    value="{{ $edit->patient_name }}" readonly>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="telp" class="form-control" id="telp" name="telp"
                                        placeholder="Nomor Telepon" required value="{{ $edit->telp }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control datepicker" data-date-format="dd-mm-yyyy"
                                        ...
                                        value="{{ date('d-m-Y', strtotime($edit->date)) }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <select class="form-control" name="time" required>
                                ...
                                @for ($i = 10; $i <= 17; $i++)
                                    <option value="{{ $i . ':00:00' }}"
                                        {{ old('time', date('H:i:s', strtotime($edit->date)) == $i . ':00:00' ? 'selected' : '') }}>
                                        {{ $i . ':00' }}</option>
                                @endfor
                            </select>
                        </div>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="treatment" id="treatment"
                                    ...
                                    @foreach ($treatment as $t)
                                        <option value="{{ $t->id }}"
                                            {{ old('treatment', $edit->treatment_code) == $t->code ? 'selected' : '' }}>
                                            {{ $t->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="user_id" id="user_id"
                                    ...
                                    @foreach ($users as $usr)
                                        <option value="{{ $usr->id }}"
                                            {{ old('user_id', $edit->user_id) == $usr->id ? 'selected' : '' }}>
            ...
            function updatePositionList(data) {
                ...
                @foreach ($photos as $photo)
                    ...
                    if (previousPhoto) {
                        ...
                        positionListHTML += '<img src="' + previousPhoto +
                            '" alt="Previous Photo" style="max-width: 100px; margin-top: 10px;">';
                        positionListHTML += '<input type="file" class="form-control-file" name="photo[]">';
                        positionListHTML += '<input type="hidden" class="form-control-file" value="' + positionId +
                            '" name="position[]">';
                        positionListHTML += '</li>';
                    }
                @endforeach
